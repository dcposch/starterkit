...
import { UserHandlers, EventTypes, Gesture } from "@use-gesture/vanilla";
import { BehaviorSubject, map, sampleTime, scan, Subject, throttleTime } from "rxjs";

type GestureState<T extends keyof UserHandlers<EventTypes>> = Parameters<UserHandlers<EventTypes>[T]>[0];
